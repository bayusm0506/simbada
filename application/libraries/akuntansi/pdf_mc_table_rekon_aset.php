...
class PDF_MC_Table_rekon_aset extends FPDF
{
...
function UPBTitle2($kode_lokasi)
{
	...
	function Rowheader($awal,$akhir)
	{
			...
			$this->MultiCell(47,10,"Nilai Perolehan",1,'C');
			$this->MultiCell(47,10,'',1,'C');

			$this->SetXY($x+262,$y2+3);
			$this->MultiCell(47,5,"Rusak Berat",1,'C');
			$this->MultiCell(47,10,$awal,1,'C');
...
function ttd2($nm_pimpinan,$nip_pimpinan,$jbt_pimpinan,$nm_pengurus,$nip_pengurus,$tanggal)
{
	...
	function Header()
	{
	    ...
	    $this->Cell(0,9,'Proses Rekon',0,0,'C');
		$this->Ln();
		$this->SetFont('Arial','B','10');
