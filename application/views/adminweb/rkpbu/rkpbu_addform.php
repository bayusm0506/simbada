...
$(this).ready( function() {
	$("#Nm_Aset5").autocomplete({
		...
		function(req, add){
  			$.ajax({
        		url: "<?php echo base_url(); ?>rkpbu/json",
          		dataType: 'json',
          		type: 'POST',
          		data: req,
          		success:    
...
$(this).ready( function() {
	$("#Nm_Rek_5").autocomplete({
		...
		function(req, add){
  			$.ajax({
        		url: "<?php echo base_url(); ?>rkpbu/json_rekening",
          		dataType: 'json',
          		type: 'POST',
          		data: req,
          		success:    
...
<!-- Validation -->
		  ...
		  <tr>
	          ...
	          <div class="form-inline"> :
		          ...
		          <input type=text name='Nm_Aset5' size=88 id='Nm_Aset5' style="width: 500px;" placeholder="ketik nama barang disini !">
	          </div>
          	</td>
		   </tr>
           <tr>
           		<td>No ID</td><td> :
	           <input type=text name='No_ID' size=5 id="No_ID" class="required input-mini" readonly='readonly' >   
	           </td>
	       </tr>
	      
	      <tr>
          	<td>Uraian Pemeliharaan</td>
          	<td> : <textarea name='Uraian' maxlength="250" id='loko' style='width: 600px; height: 80px;'></textarea></td>
		  </tr>
	      <tr>
	          <td>Lokasi</td>    
	          <td> : <input type=text name='Lokasi' style="width: 300px" size=40px id="Lokasi"></td>
		  </tr>
	      <tr>
	        	<td>Jumlah</td>
	        	<td> : <input type=text name='Jumlah' id='Jumlah' size=15 class="input-mini"></td>
		  </tr>
		  <tr>
	          <td>Harga Satuan</td>    
		  ...
		  <tr>
	          <td>Total</td>    
	          <td> : <input type=text name='Total' size=20 id="Total" disabled="true"></td>
		  </tr>
		  <tr>
	          <td>Pilih Program</td>    
	          <td> : <?php echo form_dropdown('Kd_Prog', $option_program, '',"id='id_program' style='width:600px;'"); ?>
			  </td>
		  </tr>
		  <tr>
	          <td>Pilih Kegiatan</td>    
	          <td> : <?php
						echo form_dropdown('Kd_Keg', array(''=>'- Pilih Kegiatan -'), '','id="id_kegiatan" style="width:650px;" disabled');
					 ?>
			  </td>
		  </tr>
		  <tr>
	          ...
	          <div class="form-inline"> :
				  <input type=text name='Kd_Rek_1' size=2 id='kd_rek_1' readonly='readonly' class="input-mini required">
				  <input type=text name='Kd_Rek_2' size=2 id='kd_rek_2' readonly='readonly' class="input-mini required">
				  <input type=text name='Kd_Rek_3' size=2 id='kd_rek_3' readonly='readonly' class="input-mini required">
				  <input type=text name='Kd_Rek_4' size=2 id='kd_rek_4' readonly='readonly' class="input-mini required">
				  <input type=text name='Kd_Rek_5' size=2 id='kd_rek_5' readonly='readonly' class="input-mini required">
		          <input type=text name='Nm_Rek_5' size=88 id='Nm_Rek_5' style="width:400px;" placeholder="cari kode rekening disini !">
	          </div>
          	</td>
		   </tr>
          <tr>
		  ...
		  <tr><td colspan='3'><textarea name='Keterangan' maxlength="250" id='loko' style='width: 600px; height: 80px;'></textarea></td></tr>         
