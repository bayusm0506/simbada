...
<!-- Validation -->
		  ...
		  <button id='kode-search' class='tombol' ><i class="icon-search icon-large"></i>CARI</button>
           ...
           <tr><td>No Kontrak</td>    <td> : <input type=text name='No_Kontrak' size=30 ></td>
            </tr>
          <tr><td>Tgl Kontrak/DPA/SPM</td><td> : <input type=text name='Tgl_Kontrak' size=10  id='datepicker' readonly='readonly' class="required input-small"></td>
            </tr>
          <tr><td>No Kuitansi/SP2D</td>    <td> : <input type=text name='No_Kuitansi' size=30 ></td>
            </tr>
          <tr><td>Tgl Kuitansi/SP2D</td><td> : <input type=text name='Tgl_Kuitansi' size=10  id='datepicker2' readonly='readonly' class="required input-small"></td>
            </tr>  
		  ...
		  <tr><td colspan='3'><textarea name='Dipergunakan' maxlength="500" id='loko' style='width: 600px; height: 40px;' placeholder="Ketik disini. Pisahkan dengan tanda koma (,) [max 250 karakter]"></textarea></td></tr>
