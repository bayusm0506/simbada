...
class PDF_MC_Table_Kib_D extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(140,$y);;
		$this->MultiCell(30,20,"Konstruksi",1,'C');

		$this->SetXY(170,$y);
		$this->MultiCell(20,20,"",1,'C');
		$this->SetXY(170,$y+5);
		$this->MultiCell(20,5,"Panjang\n(M2)",0,'C');
		
		$this->SetXY(190,$y);
		$this->MultiCell(20,20,"",1,'C');
		$this->SetXY(190,$y+5);
		$this->MultiCell(20,5,"Lebar\n(M)",0,'C');
		...
		$this->SetXY(230,$y+5);
		$this->MultiCell(30,5,"Letak/Lokasi\nAlamat",0,'C');
		
		$this->SetXY(260,$y);
		$this->MultiCell(40,10,"Dokumen Gedung",1,'C');
		$this->SetXY(260,$y2+8);
		$this->MultiCell(20,10,"Tanggal",1,'C');
		$this->SetXY(280,$y2+8);
		$this->MultiCell(20,10,"Nomor",1,'C');
		
		$this->SetXY(300,$y);
		$this->MultiCell(20,20,"",1,'C');
		$this->SetXY(300,$y+5);
		$this->MultiCell(20,5,"Status \n Tanah",0,'C');
		
		$this->SetXY(320,$y);
		$this->MultiCell(20,20,"",1,'C');
		$this->SetXY(320,$y+3);
		$this->MultiCell(20,5,"Nomor Kode Tanah",0,'C');
		...
		$this->SetXY(395,$y+5);
		$this->MultiCell(22,5,"Kondisi \n (B,KB,RB)",0,'C');
		
		$this->SetXY(417,$y);
		$this->MultiCell(33,20,"",1,'C');
		$this->SetXY(417,$y+8);
		$this->MultiCell(33,5,"Keterangan",0,'C');
		$this->Ln(7.5);
...
function Header()
{
    ...
    $this->Cell(0,9,'KARTU INVENTARIS BARANG (KIB) D. JALAN,IRIGASI DAN JARINGAN',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(10,60,40,20,30,20,20,20,30,20,20,20,20,20,35,22,33));
