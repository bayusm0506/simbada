<?php
	...
	$pdf->MultiCell(435,5,"DAFTAR BARANG INTRAKOMPTABEL INDUK \n ".NM_PEMDA,0,'C');
	...
	$pdf->Row(array("01", "TANAH", "", "","", "", "", "",$jumlah_intrakomptabel_kiba, $totalkiba, "", "","", ""));
	...
	$pdf->Row(array("02", "PERALATAN DAN MESIN", "", "","", "", "", "",$jumlah_intrakomptabel_kibb, $totalkibb, "", "","", ""));		
	...
	$pdf->Row(array("03", "GEDUNG & BANGUNAN", "", "","", "", "", "",$jumlah_intrakomptabel_kibc, $totalkibc, "", "","", ""));		
	...
	$pdf->Row(array("04", "JALAN, IRIGASI & JARINGAN", "", "","", "", "", "",$jumlah_intrakomptabel_kibd, $totalkibd, "", "","", ""));		
	...
	$pdf->Row(array("05", "ASET TETAP LAINYA", "", "","", "", "", "",$jumlah_intrakomptabel_kibe, $totalkibe, "", "","", ""));		
