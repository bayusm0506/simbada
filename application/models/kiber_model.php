 ...
 * Contoh_model Class
 */
class Kiber_model extends CI_Model {
	/**
	 * Constructor
	 */
...
SELECT     Ref_UPB.Nm_UPB,Ta_KIBER.*,Ref_Rek_Aset5.Nm_Aset5, ROW_NUMBER() OVER (ORDER BY Ta_KIBER.Kd_Prov) AS 
urutan		FROM  Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON 
...
AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5 LEFT JOIN Ref_UPB ON Ta_KIBER.Kd_Bidang=Ref_UPB.Kd_Bidang AND Ta_KIBER.Kd_Unit=Ref_UPB.Kd_Unit AND
Ta_KIBER.Kd_Sub=Ref_UPB.Kd_Sub AND Ta_KIBER.Kd_UPB=Ref_UPB.Kd_UPB
   WHERE $where $like AND
Ta_KIBER.Kd_Aset1 = '5') AS Ta_KIBER WHERE urutan BETWEEN $first AND $last  ORDER BY urutan ASC");				
 		return $query;
 	}
	
	/* count kib b total page */
	function count_kib($where, $like) {
 		return $this->db->query("SELECT     * FROM (SELECT     *	FROM   Ta_KIBER WHERE $where AND
Ta_KIBER.Kd_Aset1 = '5' ) AS 
Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON Ta_KIBER.Kd_Aset1=Ref_Rek_Aset5.Kd_Aset1 AND 
Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 
AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND 
Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5 $like");	
    }
	...
	{		
		$query= "SELECT   SUM(Harga) AS Harga FROM  Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON 
Ta_KIBER.Kd_Aset1=Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 
AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 
AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5  WHERE $where $like AND
Ta_KIBER.Kd_Aset1 = '5'";
	...
	/**
	 * Menampilkan data laporan Kibe
	 */
	function laporan_kibe($bidang,$unit,$sub,$upb,$like)
	{			
		...
		$query = "SELECT   Ref_Rek_Aset5.Nm_Aset5,COUNT(Ta_KIBER.No_register) as jumlah_register,MIN(Ta_KIBER.No_register) as min_register,
MAX(Ta_KIBER.No_register) as max_register,
Ta_KIBER.Kd_Prov, Ta_KIBER.Kd_Kab_Kota, Ta_KIBER.Kd_Bidang, Ta_KIBER.Kd_Unit,
Ta_KIBER.Kd_Sub, Ta_KIBER.Kd_UPB, Ta_KIBER.Kd_Aset1, Ta_KIBER.Kd_Aset2, Ta_KIBER.Kd_Aset3, 
Ta_KIBER.Kd_Aset4, Ta_KIBER.Kd_Aset5, Ta_KIBER.Kd_Pemilik,DATENAME(yyyy,Ta_KIBER.Tgl_Perolehan) as Tahun,
Ta_KIBER.Asal_usul,Ta_KIBER.Kondisi,COUNT(*) as Jumlah,
SUM(Ta_KIBER.Harga) as Harga,Ta_KIBER.Keterangan

FROM  Ta_KIBER INNER JOIN
Ref_Rek_Aset5 ON Ta_KIBER.Kd_Aset1 = Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5
 
WHERE   $where $like

GROUP BY Ta_KIBER.Kd_Prov, Ta_KIBER.Kd_Kab_Kota, Ta_KIBER.Kd_Bidang, Ta_KIBER.Kd_Unit,
Ta_KIBER.Kd_Sub, Ta_KIBER.Kd_UPB, Ta_KIBER.Kd_Aset1, Ta_KIBER.Kd_Aset2, Ta_KIBER.Kd_Aset3, 
Ta_KIBER.Kd_Aset4, Ta_KIBER.Kd_Aset5, Ta_KIBER.Kd_Pemilik, Ta_KIBER.Kd_Pemilik,Ta_KIBER.Tgl_Perolehan,Ta_KIBER.Asal_usul,
Ta_KIBER.Kondisi,Ta_KIBER.Keterangan,Ref_Rek_Aset5.Nm_Aset5 ORDER BY  Ref_Rek_Aset5.Nm_Aset5, MIN(Ta_KIBER.No_register)";
		return $this->db->query($query);
	}
	
	
	/**
	 * Tampilkan total harga laporan Kibe
	 */
	function total_laporan_kibe($bidang,$unit,$sub,$upb,$like)
	{	
	...
	{			
		...
		$query = "SELECT  Nm_UPB,Ref_Rek_Aset5.Nm_Aset5,COUNT(Ta_KIBER.No_register) as jumlah_register,MIN(Ta_KIBER.No_register) as min_register,
MAX(Ta_KIBER.No_register) as max_register,
Ta_KIBER.Kd_Prov, Ta_KIBER.Kd_Kab_Kota, Ta_KIBER.Kd_Bidang, Ta_KIBER.Kd_Unit,
Ta_KIBER.Kd_Sub, Ta_KIBER.Kd_UPB, Ta_KIBER.Kd_Aset1, Ta_KIBER.Kd_Aset2, Ta_KIBER.Kd_Aset3, 
Ta_KIBER.Kd_Aset4, Ta_KIBER.Kd_Aset5, Ta_KIBER.Kd_Pemilik,DATENAME(yyyy,Ta_KIBER.Tgl_Perolehan) as Tahun,
...
FROM  Ta_KIBER INNER JOIN
Ref_Rek_Aset5 ON Ta_KIBER.Kd_Aset1 = Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5
INNER JOIN Ref_UPB ON Ta_KIBER.Kd_Bidang=Ref_UPB.Kd_Bidang AND Ta_KIBER.Kd_Unit=Ref_UPB.Kd_Unit AND Ta_KIBER.Kd_Sub=Ref_UPB.Kd_Sub AND Ta_KIBER.Kd_UPB=Ref_UPB.Kd_UPB
...
Ta_KIBER.Kd_Sub, Ta_KIBER.Kd_UPB, Ta_KIBER.Kd_Aset1, Ta_KIBER.Kd_Aset2, Ta_KIBER.Kd_Aset3, 
Ta_KIBER.Kd_Aset4, Ta_KIBER.Kd_Aset5, Ta_KIBER.Kd_Pemilik, Ta_KIBER.Kd_Pemilik,Ta_KIBER.Tgl_Perolehan,Ta_KIBER.Asal_usul,
Ta_KIBER.Kondisi,Ta_KIBER.Keterangan,Ref_Rek_Aset5.Nm_Aset5,Nm_UPB ORDER BY  Nm_UPB,Ref_Rek_Aset5.Nm_Aset5, MIN(Ta_KIBER.No_register)";
		return $this->db->query($query);
	}
	 ...
	 */
	function kibe_mutasi($bidang,$unit,$sub,$upb,$like)
	{			
		$kb 	=  $this->session->userdata('kd_bidang');
		$ku 	=  $this->session->userdata('kd_unit');
		$ks 	=  $this->session->userdata('kd_sub_unit');
...
COUNT(*) as Jumlah, 
SUM(Harga) as Harga
 from Ref_Rek_Aset2 LEFT JOIN (SELECT * from Ta_KIBER WHERE $where $akhir) as Ta_KIBER ON 
Ta_KIBER.Kd_Aset1=Ref_Rek_Aset2.Kd_Aset1 AND
Ta_KIBER.Kd_Aset2=Ref_Rek_Aset2.Kd_Aset2   WHERE Ref_Rek_Aset2.Kd_Aset1=5
...
Ta_KIBER.Kd_Aset2=Ref_Rek_Aset2.Kd_Aset2   WHERE Ref_Rek_Aset2.Kd_Aset1=5";
	...
	{	
		...
		if ($this->session->userdata('lvl') == 01){
		$where = "WHERE (Ta_KIBER.Kd_Bidang = $bidang) 
			  AND (Ta_KIBER.Kd_Unit = $unit) 
			  AND (Ta_KIBER.Kd_Sub = $sub) 
			  AND (Ta_KIBER.Kd_UPB = $upb) AND $like";
		}elseif ($this->session->userdata('lvl') == 02){
			$where = "WHERE (Ta_KIBER.Kd_Bidang = $kb )
			  AND (Ta_KIBER.Kd_Unit =$ku )
			  AND (Ta_KIBER.Kd_Sub = $ks) 
			  AND (Ta_KIBER.Kd_UPB = $upb) AND $like";
		}else{
			$where = "WHERE (Ta_KIBER.Kd_Bidang = $kb) 
			  AND (Ta_KIBER.Kd_Unit = $ku) 
			  AND (Ta_KIBER.Kd_Sub = $ks) 
			  AND (Ta_KIBER.Kd_UPB = $kupb) AND $like";
		}
		
$query = "select Ref_Rek_Aset2.Kd_Aset1,Ref_Rek_Aset2.Kd_Aset2,Nm_Aset2,COUNT(*) as Jumlah, SUM(Harga) as Harga from Ref_Rek_Aset2 LEFT JOIN (SELECT * from Ta_KIBER $where) as Ta_KIBER ON 
Ta_KIBER.Kd_Aset1=Ref_Rek_Aset2.Kd_Aset1 AND
Ta_KIBER.Kd_Aset2=Ref_Rek_Aset2.Kd_Aset2   WHERE Ref_Rek_Aset2.Kd_Aset1=5
GROUP BY Ref_Rek_Aset2.Kd_Aset1,Ref_Rek_Aset2.Kd_Aset2,Nm_Aset2 ";
	...
	{	
		...
		$query = "SELECT COUNT(*) as Jumlah,SUM(Harga) as Harga FROM Ta_KIBER $where";
		
        return $this->db->query($query);
	}
	
	/**
	 * Menampilkan data kib e rekap gabungan pemda
	 */
	function kibe_rekap($kd_bidang,$kd_unit,$kd_sub_unit,$like)
	{	
		$this->db->select_SUM('Harga');
	...
	/**
	 * Menampilkan total data kib e rekap gabungan pemda
	 */
	function total_kibe_rekap($like)
	{	
		$this->db->select_SUM('Harga');
		$this->db->where("$like");
		$array_keys_values = $this->db->get($this->table);
	 ...
	 */
	function get_kibe_by_id($kd_prov,$kd_kab,$kd_bidang,$kd_unit,$kd_sub,$kd_upb,$kd_aset1,$kd_aset2,$kd_aset3,$kd_aset4,$kd_aset5,$no_register)
	{
		if ($this->session->userdata('lvl') == 01){
			$this->db->where('Kd_Bidang',$kd_bidang);
			$this->db->where('Kd_Unit',$kd_unit);
	 ...
	 */
	 /*
	function daTa_KIBER($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahun)
	{		
		$this->db->select('Ta_KIBER.*,Ref_Rek_Aset5.Nm_Aset5');
        $this->db->from('Ta_KIBER');
        $this->db->join('Ref_Rek_Aset5', 'Ta_KIBER.Kd_Aset1 = Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5');
		$this->db->where('Ta_KIBER.Kd_Bidang',$kd_bidang);
		$this->db->where('Ta_KIBER.Kd_Unit',$kd_unit);
		$this->db->where('Ta_KIBER.Kd_Sub',$kd_sub);
		$this->db->where('Ta_KIBER.Kd_UPB',$kd_upb);
	...
	/*function getTotalRowAllData($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahun){
			...
			$this->db->where('Ta_KIBER.Kd_Sub',$kd_sub);
			$this->db->where('Ta_KIBER.Kd_UPB',$kd_upb);
			$this->db->like('Ta_KIBER.Tgl_Perolehan',$tahun);
			return $this->db->count_all($this->table);
	} */
	...
	function caridata($limit, $offset,$kd_bidang,$kd_unit,$kd_sub,$kd_upb,$q,$s){	
		...
		if ($q == 'all'){
			...
			$like = "AND Ta_KIBER.$q like '%$s%'";	
		}
		
		$query= $this->db->query("SELECT     urutan,* FROM         (SELECT     *, ROW_NUMBER() OVER (ORDER BY Kd_Prov) AS urutan
		FROM         Ta_KIBER where Ta_KIBER.Kd_Bidang=$kd_bidang AND Ta_KIBER.Kd_Unit=$kd_unit AND Ta_KIBER.Kd_Sub=$kd_sub AND Ta_KIBER.Kd_UPB=$kd_upb
		$like) AS Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON Ta_KIBER.Kd_Aset1=Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 
		AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5 WHERE urutan BETWEEN $first AND $last");				
 		return $query;
	...
	*/
	...
	{		
		$this->db->limit('10');
		$this->db->select('Ta_KIBER.*,Ref_UPB.Nm_UPB');
        $this->db->from('Ta_KIBER');
        $this->db->join('Ref_UPB', 'Ta_KIBER.Kd_Prov = Ref_UPB.Kd_Prov AND Ta_KIBER.Kd_Kab_Kota = Ref_UPB.Kd_Kab_Kota AND Ta_KIBER.Kd_Bidang = Ref_UPB.Kd_Bidang AND Ta_KIBER.Kd_Unit = Ref_UPB.Kd_Unit AND Ta_KIBER.Kd_Sub = Ref_UPB.Kd_Sub AND Ta_KIBER.Kd_UPB = Ref_UPB.Kd_UPB');
		return $this->db->get();
	}/*
	...
	{			
		...
		if ($this->session->userdata('lvl') == 02){
		$x = "where Ta_KIBER.Kd_Bidang=$kd_bidang AND Ta_KIBER.Kd_Unit=$kd_unit AND Ta_KIBER.Kd_Sub=$kd_sub AND Ta_KIBER.Kd_UPB=$kd_upb
		AND Ta_KIBER.Tgl_Perolehan like '%$tahun%'";
		}else{
		$x = '';
		}
		...
		$query= $this->db->query("SELECT     urutan,* FROM         (SELECT     *, ROW_NUMBER() OVER (ORDER BY Kd_Prov) AS urutan
		FROM         Ta_KIBER $x) AS Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON Ta_KIBER.Kd_Aset1=Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 
		AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5 WHERE urutan BETWEEN $first AND $last");
	...
	*/
	...
	function total_Kibe($where)
	{	
		$query= "SELECT   SUM(Harga) AS Harga FROM  Ta_KIBER INNER JOIN Ref_Rek_Aset5 ON 
Ta_KIBER.Kd_Aset1=Ref_Rek_Aset5.Kd_Aset1 AND Ta_KIBER.Kd_Aset2 = Ref_Rek_Aset5.Kd_Aset2 
AND Ta_KIBER.Kd_Aset3 = Ref_Rek_Aset5.Kd_Aset3 AND Ta_KIBER.Kd_Aset4 = Ref_Rek_Aset5.Kd_Aset4 
AND Ta_KIBER.Kd_Aset5 = Ref_Rek_Aset5.Kd_Aset5  WHERE $where AND
Ta_KIBER.Kd_Aset1 = '1'";
