<?php
	...
	$pdf->MultiCell(280,5,"BERITA ACARA PINJAM PAKAI",0,'C');
	$pdf->SetFont('Arial','',12);
	$No_Dokumen = sprintf ("%03u", $No_Dokumen);
	$pdf->MultiCell(280,5,"NOMOR : 032/".$No_Dokumen."/BAPP/".strtoupper($this->session->userdata('username'))."/".thn($Log_entry),0,'C');
	$pdf->Ln(20);
	...
	$pdf->Ln(10);
	$pdf->MultiCell(280,5,"menyatakan dengan sesungguhnya bahwa PIHAK PERTAMA telah memberi pinjam pakai kepada PIHAK KEDUA dan PIHAK KEDUA telah menerima dari PIHAK PERTAMA barang berupa sebagai berikut :",0,'L');
	$pdf->Ln(5);
	...
	$pdf->MultiCell(280,5,"dalam keadaan baik dengan ketentuan sebagaimana diatur dalam surat perjanjian tentang pinjam pakai barang milik daerah Pemerintah Kabupaten Mandailing Natal.",0,'L');
	$pdf->Ln(10);
	$pdf->MultiCell(280,5,"Demikian berita acara ini diperbuat dengan sebenarnya dalam rangkap 2 (dua) untuk dapat dipergunakan sebagaimana mestinya.",0,'L');
	...
	$pdf->AddPage();
	$pdf->SetFont('Arial','B',15);
	$pdf->MultiCell(280,5,"SURAT PERJANJIAN PINJAM PAKAI",0,'C');
	$pdf->SetFont('Arial','',12);
	$No_Dokumen = sprintf ("%03u", $No_Dokumen);
	$pdf->MultiCell(280,5,"NOMOR : 032/".$No_Dokumen."/SPPP/".strtoupper($this->session->userdata('username'))."/".thn($Log_entry),0,'C');
	$pdf->Ln(10);
	...
	$pdf->Identitas2($Nama_Pihak_2,$Nip_Pihak_2,$Jabatan_Pihak_2,$Alamat_Pihak_2);
	$pdf->Ln(10);
	$pdf->MultiCell(280,5,"Bersepakat untuk membuat perjanjian pinjam pakai barang milik Pemerintah Kabupaten Mandailing Natal berupa :",0,'L');
	$pdf->Ln(5);
	...
	$pdf->Ln(10);
	$pdf->Pasal($Tgl_Pinjam,$Tgl_Kembali);
	...
	$pdf->Output("SIMDO_Berita_Acara.pdf","I");
?>