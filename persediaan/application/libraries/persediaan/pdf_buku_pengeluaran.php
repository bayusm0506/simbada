...
class PDF_Buku_Pengeluaran extends FPDF
{
...
function Rowheader()
{
		...
		$h=0;
        $this->Rect($x,$y,$w,$h);
        $this->MultiCell(20,15,"No.",1,'C');

        $this->SetXY(30,$y);
        $this->MultiCell(35,15,"Tanggal",1,'C');

        $this->SetXY(65,$y);
        $this->MultiCell(30,15,"Nomor Urut",1,'C');
        ...
        $this->SetXY(195,$y);
        $this->MultiCell(35,15,"Jumlah",1,'C');

        $this->SetXY(230,$y);
        $this->MultiCell(45,15,"Harga Satuan",1,'C');

        $this->SetXY(275,$y);
        $this->MultiCell(45,15,"Total Harga",1,'C');

        $this->SetXY(320,$y);
        $this->MultiCell(50,15,"Untuk",1,'C');

        $this->SetXY(370,$y);
        $this->MultiCell(35,15,"Tgl Penyerahan",1,'C');

		$this->SetXY(405,$y);
        $this->MultiCell(45,15,"Keterangan",1,'C');
		$this->Ln(0.7);
}
...
function Header()
{
	...
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(20,35,30,30,70,35,45,45,50,35,45));
