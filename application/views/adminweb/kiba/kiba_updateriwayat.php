...
$(function() {
    $('#kd_riwayat').change(function() {
        ...
        if (n == 1){
            ...
            $("#id_kondisi").show("slow");
        }else if ($("#kd_riwayat").val() == 9){ /* Kemitraan Dengan Pihak Ke 3 */
            $(".att_all").hide("slow");
            $("#id_kemitraan").show("slow");
            $("#id_pinjam").show("slow");
                          ...
                          <form method=POST action="<?php echo $form_action; ?>" name='fadd' id='formku'>
                              ...
                              <table  width='100%'>
                                ...
                                <tr>
                                    <td>Riwayat</td>
                                    <td> : 
                                    <?php echo form_dropdown('Kd_Riwayat', $option_q, $Kd_Riwayat,'class="input-large required" id="kd_riwayat"'); ?>
                                ...
                                <tr>
                                      <td>Tgl Dokumen</td>
                                      <td> : <input type=text name='Tgl_Dokumen' size=10 id='datepicker' value="<?php echo tgl_ymd($Tgl_Dokumen) ?>" readonly='readonly' class="input-small">
                                      </td>
                                    </tr>
                                <tr>
                                  <td>No Dokumen</td>
                                  <td> : <input type=text name='No_Dokumen' value="<?php echo $No_Dokumen ?>" maxlength="50" size=15 required ></td>          
                                </tr>
                                ...
                                <tr id="id_kemitraan" class="att_all" style="display:none;">
                                        <td>Jenis Kemitraan</td>
                                        <td>:
                                        <?php
                                        $kemitraan = array('1' => 'Sewa','2'=>'KSP','3'=>'BGS','4'=>'BSG');
                                        echo form_dropdown('Kd_Sub_Riwayat', $kemitraan, '','class="input-medium required"');
                                        ?> 
                                        </td>
                                </tr>
                                ...
                                <tr id="id_harga" class="att_all" <?php if($Kd_Riwayat != 2){ ?> style="display:none;" <?php } ?> >
                                    <td>Nilai</td>    
                                    <td> : <input type=text name='Harga' value="<?php echo nilai($Harga) ?>" size=20 id="Harga" class="required number">
                                    <span id='pesan'></span></td>
                                </tr>

                                <tr id="id_masa_manfaat" class="att_all" <?php if($Kd_Riwayat != 2){ ?> style="display:none;" <?php } ?>>
                                    <td>Masa Manfaat</td>    
                                    <td> :
                                        <?php
                                ...
                                <tr>
                                  <td colspan='3'><textarea name='Keterangan' maxlength="250" style='width: 600px; height: 80px;'><?php echo $Keterangan ?></textarea></td>
                                </tr>
                                    
                                <tr>
                                  <td colspan=3>
                                    <input type="submit" name="submit" class="submit" value="UPDATE" id="submit">
