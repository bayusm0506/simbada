...
class PDF_MC_Table_kib_c_unit extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(140,$y+3);
		$this->MultiCell(30,5,"Kondisi Bangunan\n(B,KB,RB)",0,'C');

		$this->SetXY(170,$y);
		$this->MultiCell(50,10,"Konstruksi Bangunan",1,'C');
		$this->SetXY(170,$y2+8);
		$this->MultiCell(25,5,"Bertingkat/\nTidak",1,'C');
		$this->SetXY(195,$y2+8);
		$this->MultiCell(25,5,"Beton/\nTidak",1,'C');
		
				
		$this->SetXY(220,$y);
		$this->MultiCell(20,20,"",1,'C');
		$this->SetXY(220,$y+3);
		$this->MultiCell(20,5,"Luas Lantai (M2)",0,'C');
...
function Header()
{
    ...
    $this->Cell(0,9,'KARTU INVENTARIS BARANG (KIB) C. GEDUNG & BANGUNAN ',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(10,60,40,20,30,25,25,20,30,20,20,15,20,20,20,35,30));
