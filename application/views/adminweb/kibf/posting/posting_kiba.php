...
<!-- Validation -->
           <form method=POST action="<?php echo base_url().'pengadaan/kiba_process'; ?>" name='fadd' id='formku'>
          <table  width='100%'>
          ...
          <div class="form-inline"> :
           ...
           <span id='register'>
		       <input type=text name='No_Register' value="<?php echo KIBA_lastRegister($Kd_Prov,$Kd_Kab_Kota,$Kd_Bidang,$Kd_Unit,$Kd_Sub,$Kd_UPB,$Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5); ?>" size=5 id="No_Register" class="required input-mini" readonly='readonly'>
		   </span>
              <span id="msg"></span>     
           </td>
           </tr>

          <tr><td>Tgl Pembelian</td><td> : <input type=text name='Tgl_Perolehan' value="<?php echo tgl_ymd($Tgl_Perolehan) ?>" size=10  id='datepicker' readonly='readonly' class="required input-small"></td>
            </tr>
         ...
         <tr><td>Luas (M2)</td>    <td> : <input type=text name='Luas_M2' size=15 id='Luas_M2' class="required"></td>
            </tr>
          <tr><td>Alamat</td>    <td> : <textarea name='Alamat' id='loko' style='width: 600px; height: 80px;'></textarea></td>
            </tr>
          <tr><td>Hak Tanah</td>    <td> :  <?php
      $option_hak = array('Hak Pakai' => 'Hak Pakai','Hak Pengelolaan'=>'Hak Pengelolaan');
      
      echo form_dropdown('Hak_Tanah', $option_hak, '');
      ?>
      </td>
            </tr>
      <tr><td>Tgl Sertifikat</td>    <td> : <input type=text name='Sertifikat_Tanggal' size=10 id='datepicker3' readonly='readonly' class="input-small"></td>
        </tr>
      <tr><td>Nomor Sertifikat</td>    <td> : <input type=text name='Sertifikat_Nomor' size=30 ></td>
        </tr>
      ...
      ?>
        ...
        <tr>
            <td>No SP2D</td>    <td> : <input type=text name='No_SP2D' value="" size=80 ></td>
        </tr>
        <tr>
            <td>Penggunaan</td>    <td> : <input type=text name='Penggunaan' value="" size=80 ></td>
        </tr>
          <td>Harga</td>    
