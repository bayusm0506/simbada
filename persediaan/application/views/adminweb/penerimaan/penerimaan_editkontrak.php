			          ...
			          <div class="span8">
				          <table width='100%'>
					          <tr>
					          	...
					          	<td> : <input type=text name='Tgl_Diterima' id='datepicker' readonly='readonly' value="<?php echo $Tgl_Diterima; ?>" class="required input-small"></td>
					          </tr>
		            		  <tr>
		            		  	<td>Dari ( Nama Rekanan )</td>
		            		  	<td> : <input type=text name='Nm_Rekanan' value="<?php echo $Nm_Rekanan; ?>"  size=30 ></td>
							  </tr>
							  <tr>
		            		  	<td>No Kontrak/SP/SPK/Kwitansi</td>
		            		  	<td> : <input type=text name='No_Kontrak' value="<?php echo $No_Kontrak; ?>" size=30 ></td>
							  </tr>
					          <tr>
					          	<td>Tanggal Kontrak/SPK/Kwitansi</td>
					          	<td> : <input type=text name='Tgl_Kontrak' value="<?php echo $Tgl_Kontrak; ?>" size=10  id='datepicker2' readonly='readonly' class="required input-small"></td>
		            		  </tr>
							  <tr>
		            		  	<td>No BA Pemeriksaan</td>
		            		  	<td> : <input type=text name='No_BA_Pemeriksaan' value="<?php echo $No_BA_Pemeriksaan; ?>" size=30 ></td>
							  </tr>
					          <tr>
					          	<td>Tgl BA Pemeriksaan</td>
					          	<td> : <input type=text name='Tgl_BA_Pemeriksaan' value="<?php echo $Tgl_BA_Pemeriksaan; ?>" size=10  id='datepicker3' readonly='readonly' class="required input-small"></td>
		            		  </tr>
		            		  <tr>
		            		  	<td class='ket' colspan="2"><b>Keterangan / Uraian</b></td>
							  </tr>
							  <tr><td colspan='2'><textarea name='Keterangan' id='loko' style='width: 80%; height: 80px;'><?php echo $Keterangan; ?></textarea></td></tr>
				          </table>
				       </div>
