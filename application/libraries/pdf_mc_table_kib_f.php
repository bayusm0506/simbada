...
class PDF_MC_Table_Kib_F extends FPDF {
    var $widths; 
    var $aligns; 
...
function UPBTitle2($kode_lokasi)
{
 ...
 function Rowheader() { 
     ...
     $this->SetXY(20,$y);
     $this->MultiCell(55,20,"",1,'C'); 
     $this->SetXY(20,$y+5); 
     $this->MultiCell(55,5,"Jenis Barang/\n Nama Barang",0,'C'); 
     
     $this->SetXY(75,$y); 
     $this->MultiCell(30,20,"",1,'C'); 
     $this->SetXY(75,$y+5); 
     $this->MultiCell(30,5,"Bangunan\n(P, SP, D)",0,'C');
     
     $this->SetXY(105,$y); 
     $this->MultiCell(60,10,"Konstruksi Bangunan",1,'C'); 
     $this->SetXY(105,$y2+8);
     $this->MultiCell(30,5,"Bertingkat/\nTidak",1,'C');
     $this->SetXY(135,$y2+8); 
     $this->MultiCell(30,5,"Beton/\nTidak",1,'C');
     
     $this->SetXY(165,$y); 
     $this->MultiCell(20,25,"",1,'C'); 
     $this->SetXY(165,$y+5); 
     $this->MultiCell(20,5,"Luas\n\n(M2)",0,'C');
     
     $this->SetXY(185,$y); 
     $this->MultiCell(45,25,"",1,'C'); 
     $this->SetXY(185,$y+5); 
     $this->MultiCell(45,5,"Letak / Lokasi\n\nAlamat",0,'C');
     
     $this->SetXY(230,$y); 
     $this->MultiCell(50,10,"Dokumen \n",1,'C'); 
     $this->SetXY(230,$y2+8);
     $this->MultiCell(25,5,"\nTanggal",1,'C');
     $this->SetXY(255,$y2+8);
     $this->MultiCell(25,5,"\nNomor",1,'C');
     ...
     $this->SetXY(280,$y+3); 
     $this->MultiCell(25,5,"Tgl, Bulan \nTahun\nMulai",0,'C');

     $this->SetXY(305,$y);
     $this->MultiCell(30,20,"",1,'C'); 
     $this->SetXY(305,$y+7); 
     $this->MultiCell(30,5,"Status Tanah\n ",0,'C');
     
     $this->SetXY(335,$y);
     $this->MultiCell(25,20,"Nomor",1,'C'); 
     $this->SetXY(335,$y+3); 
     $this->MultiCell(25,5,"\n\nKode Tanah",0,'C');
     
     $this->SetXY(360,$y);
     $this->MultiCell(30,20,"Asal-usul",1,'C'); 
     $this->SetXY(360,$y+3); 
     $this->MultiCell(30,5,"\n\nPembayaran",0,'C');
     
     $this->SetXY(390,$y);
     $this->MultiCell(30,20,"Nilai Kontrak",1,'C'); 
     $this->SetXY(390,$y+3); 
     $this->MultiCell(30,5,"\n\n(ribuan Rp)",0,'C');
...
function ttd2($nm_pimpinan,$nip_pimpinan,$jbt_pimpinan,$nm_pengurus,$nip_pengurus,$tanggal)
{
 ...
 function Header() 
 {
     if( $this->PageNo() != 1){
         ...
         $this->Cell(0,9,'KARTU INVENTARIS BARANG (KIB) F.KONSTRUKSI DALAM PENGERJAAN',0,0,'C');
         $this->Ln(); $this->SetFont('Arial','B','10'); 
         $this->SetWidths(array(10,35,30,30,30,20,35,25,25,25,30,25,30,30,35));
 ...
 function Footer() {
     ...
     $this->MultiCell(0,4,'Halaman '.$this->PageNo(),0,'R'); 
 }
