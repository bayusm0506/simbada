...
class PDF_MC_Table_usul_rkpbu extends FPDF
{
...
function Rowheader()
{
        ...
        $this->SetXY(25,$y);
        $this->MultiCell(90,22,"Program/Kegiatan/Output",1,'C');

		$this->SetXY(115,$y);
		$this->MultiCell(205,7,"Barang Yang Dipelihara",1,'C');
		$this->SetXY(115,$y+7);
		...
		$this->SetXY(230,$y+7);
		$this->MultiCell(30,15,"Status Barang",1,'C');
		...
		$this->SetXY(320,$y);
		$this->MultiCell(105,7,"Usulan Kebutuhan Dipelihara",1,'C');
		$this->SetXY(320,$y+7);
		$this->MultiCell(65,15,"Nama Pemeliharaan",1,'C');
		$this->SetXY(385,$y+7);
		$this->MultiCell(20,15,"Jumlah",1,'C');
		$this->SetXY(405,$y+7);
		$this->MultiCell(20,15,"Satuan",1,'C');
