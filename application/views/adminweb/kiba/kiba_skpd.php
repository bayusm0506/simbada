...
<div class="row">
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                       ...
                       <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($tab1) ?  $tab1: '#'; ?>" class="tab-page" data-toggle="tab">DATA KIB A. TANAH</a></li>
                  ...
                  <table class="table table-striped">
					...
					echo "<tr id='listhapus_$i'>
						  ...
						  if ($row->aktif == NULL) {
							echo "<a title='data belum di verifikasi admin'><i class='icon-remove red'></i></a>";
							}else{
							echo "<a title='data aktif'><i class='icon-ok green'></i></a>";
							}
						  ...
						  echo "</td>
                            <td>
                                            <div class='btn-group'>
                                                ...
                                                <ul class='dropdown-menu'><li>".anchor('kiba/lihat/'
			...
			"<i class='icon-eye-open'></i>Lihat",array('class' => 'update'))."</li></ul>
                                            </div>
                                        </td>
                      </tr>";
				 $i++;
