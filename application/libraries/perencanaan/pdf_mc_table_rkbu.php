...
class PDF_MC_Table_rkbu extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(25,$y);
		$this->MultiCell(105,15,"",1,'C');
		$this->SetXY(25,$y2);
		$this->MultiCell(105,5,"Nama / Jenis Barang",0,'C');

		$this->SetXY(130,$y);
		$this->MultiCell(75,15,"Spesifikasi",1,'C');
		...
		$this->SetXY(225,$y);
		$this->MultiCell(50,15,"Harga Satuan",1,'C');

		$this->SetXY(275,$y);
		$this->MultiCell(50,15,"Jumlah Biaya",1,'C');
		
		$this->SetXY(325,$y);
		$this->MultiCell(70,15,"Kode Rekening",1,'C');
		
		$this->SetXY(395,$y);
		$this->MultiCell(55,15,"Keterangan",1,'C');
