...
<script>
	...
	if(confirm("Yakin data ini akan dihapus dalam usulan penghapusan ??"))
	{
		...
		$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>penghapusan/ajax_hapus",
				data:kode,
			 	cache: false,
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            <li <?php if ($this->uri->segment(2) == 'kiba' || $this->uri->segment(2) == '' ) {echo "class='active'";}?>>
                            <a href="<?php echo ! empty($kiba) ?  $kiba: '#'; ?>" class="tab-page" data-toggle="tab">KIB A
