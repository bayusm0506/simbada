...
class PDF_Buku_Penerimaan extends FPDF
{
...
function Rowheader()
{
        ...
        $this->SetXY(25,$y);
        $this->MultiCell(30,15,"Tanggal",1,'C');

        $this->SetXY(55,$y);
        $this->MultiCell(50,15,"Dari",1,'C');

        $this->SetXY(105,$y);
        $this->MultiCell(60,7,"Dokumen Faktur",1,'C');
        $this->SetXY(105,$y+7);
        $this->MultiCell(30,8,"Nomor",1,'C');
        $this->SetXY(135,$y+7);
        ...
        $this->SetXY(195,$y);
        $this->MultiCell(70,15,"Nama Barang",1,'C');

        $this->SetXY(265,$y);
        $this->MultiCell(30,15,"Jumlah",1,'C');

        $this->SetXY(295,$y);
        $this->MultiCell(30,15,"Harga Satuan",1,'C');

        $this->SetXY(325,$y);
        $this->MultiCell(30,15,"Total Harga",1,'C');

        $this->SetXY(355,$y);
        $this->MultiCell(60,7,"BA Penerimaan",1,'C');
        $this->SetXY(355,$y+7);
        $this->MultiCell(30,8,"Nomor",1,'C');
        $this->SetXY(385,$y+7);
        $this->MultiCell(30,8,"Tanggal",1,'C');
		...
		$this->SetXY(415,$y);
        $this->MultiCell(35,15,"Keterangan",1,'C');
		$this->Ln(0.7);
}
...
function Header()
{
    ...
    $this->Cell(0,9,'BUKU PENERIMAAN BARANG HABIS PAKAI',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(15,30,50,30,30,30,70,30,30,30,30,30,35));
