...
class PDF_MC_Table_lapbininvent extends FPDF
{
...
function UPBTitle($bidang,$unit,$sub_unit,$upb)
{
		...
		$this->Cell(0,5,'12.02.14.01.01.01',0,0,'R');
		$this->Ln();
...
function ttd2($nm_pimpinan,$nip_pimpinan,$jbt_pimpinan,$nm_pengurus,$nip_pengurus,$tanggal)
{
	...
	$this->Cell(615,5,'NIP . 19591231 198801 1 012',0,'B', 'C');
