...
class PDF_MC_Table_telaah_rkbmd extends FPDF
{
...
function Rowheader()
{
        ...
        $this->SetXY(25,$y);
		$this->MultiCell(160,10,"Usulan RKBMD",1,'C');
		$this->SetXY(25,$y+10);
		$this->MultiCell(50,10,"Program/Kegiatan/Output",1,'C');
		$this->SetXY(75,$y+10);
		$this->MultiCell(30,10,"Kode Barang",1,'C');
		$this->SetXY(105,$y+10);
		$this->MultiCell(40,10,"Nama Barang",1,'C');
		$this->SetXY(145,$y+10);
		$this->MultiCell(20,10,"Jumlah",1,'C');
		$this->SetXY(165,$y+10);
		$this->MultiCell(20,10,"Satuan",1,'C');

		$this->SetXY(185,$y);
		$this->MultiCell(40,10,"Kebutuhan Maksimum",1,'C');
		$this->SetXY(185,$y+10);
		$this->MultiCell(20,10,"Jumlah",1,'C');
		$this->SetXY(205,$y+10);
		$this->MultiCell(20,10,"Satuan",1,'C');
		...
		$this->SetXY(225,$y);
		$this->MultiCell(80,10,"Data Daftar Barang Yang Dioptimalkan",1,'C');
		$this->SetXY(225,$y+10);
		$this->MultiCell(20,10,"Jumlah",1,'C');
		$this->SetXY(245,$y+10);
		$this->MultiCell(20,10,"Satuan",1,'C');
		...
		$this->SetXY(305,$y);
		$this->MultiCell(40,10,"",1,'C');
		$this->SetXY(305,$y+1);
		$this->MultiCell(40,4,"Kebutuhan Riil Barang Milik Daerah",0,'C');
		$this->SetXY(305,$y+10);
		$this->MultiCell(20,10,"Jumlah",1,'C');
		$this->SetXY(325,$y+10);
		$this->MultiCell(20,10,"Satuan",1,'C');
		...
		$this->MultiCell(40,10,"",1,'C');
		$this->SetXY(345,$y+1);
		$this->MultiCell(40,4,"RKBMD Pengadaan Yang Disetujui",0,'C');
		$this->SetXY(345,$y+10);
		$this->MultiCell(20,10,"Jumlah",1,'C');
		$this->SetXY(365,$y+10);
		$this->MultiCell(20,10,"Satuan",1,'C');
		...
		$this->SetXY(385,$y);
		$this->MultiCell(35,20,"Cara Pemenuhan",1,'C');
