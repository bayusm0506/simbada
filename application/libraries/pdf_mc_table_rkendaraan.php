...
class PDF_MC_Table_rkendaraan extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(55,$y2+3);
		$this->MultiCell(30,5,"Jumlah Roda",0,'C');
		
		$this->SetXY(85,$y);
		$this->MultiCell(80,20,"Nama Barang",1,'C');
...
function Header()
{
    ...
    $this->Cell(0,9,'REKAPITULASI KENDARAAN DINAS MENURUT JUMLAH RODA',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
