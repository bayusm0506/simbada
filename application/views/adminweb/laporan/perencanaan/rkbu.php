<?php
	...
	$this->load->library('perencanaan/PDF_MC_Table_rkbu');
	
	$pdf=new PDF_MC_Table_rkbu('L','mm','f4');
	$pdf->Open();
	$pdf->AddPage();
	$pdf->Image(base_url().'asset/img/logo.png',10,5,22,0,'PNG');
	$pdf->SetFont('Arial','B',15);
	$pdf->MultiCell(435,5,"DAFTAR RENCANA KEBUTUHAN BARANG \n ".NM_PEMDA,0,'C');
	...
	$pdf->SetWidths(array(15,105,75,20,50,50,70,55));
	$pdf->Rowheader();
