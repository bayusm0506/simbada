	...
	$("#Nm_Aset6").autocomplete({
 	...
 	select: 
 		function(event, ui) {
			...
			var kode = {
						kd_bidang:<?php echo $Kd_Bidang; ?>,
						kd_unit:<?php echo $Kd_Unit; ?>,
						kd_sub:<?php echo $Kd_Sub; ?>,
						kd_upb:<?php echo $Kd_UPB; ?>,
...
<!-- Validation -->
		  ...
		  <tr>
	          ...
	          <div class="form-inline"> :
				  ...
				  <input type=text name='Kd_Aset6' size=2 id='kd_aset6' readonly='readonly' class="input-mini required">
		          <input type=text name='Nm_Aset6' size=88 id='Nm_Aset6' placeholder="ketik nama barang disini !">
	          </div>
          	</td>
		   </tr>
           <tr><td>No ID</td><td> : 
           ...
           <input type=text name='No_ID' size=5 id="No_ID" class="required input-mini" readonly='readonly' >
            ...
            <tr><td>Jumlah</td>    <td> : <input type=text name='Jumlah' id='Jumlah' size=15 class="input-mini"></td>
		    </tr>
		  <tr>
	          <td>Harga Satuan</td>    
		  ...
		  <tr>
		  	<td>Kebutuhan Max</td>
		  	<td> : <input type=text name='Kebutuhan_Max' size=15 class="input-mini"></td>
		  </tr>
		  <tr>
	          <td>Pilih Program</td>    
