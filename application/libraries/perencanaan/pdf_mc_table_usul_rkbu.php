...
class PDF_MC_Table_usul_rkbu extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(25,$y);
		$this->MultiCell(90,15,"",1,'C');
		$this->SetXY(25,$y2);
		$this->MultiCell(90,5,"Program/Kegiatan/Output",0,'C');

		$this->SetXY(115,$y);
		$this->MultiCell(115,7,"Usulan BMD",1,'C');
		$this->SetXY(115,$y+7);
		$this->MultiCell(30,8,"Kode Barang",1,'C');
		$this->SetXY(145,$y+7);
		$this->MultiCell(45,8,"Nama Barang",1,'C');
		$this->SetXY(190,$y+7);
		$this->MultiCell(20,8,"Jumlah",1,'C');
		$this->SetXY(210,$y+7);
		$this->MultiCell(20,8,"Satuan",1,'C');


		$this->SetXY(230,$y);
		$this->MultiCell(40,7,"Kebutuhan Max",1,'C');
		$this->SetXY(230,$y+7);
		$this->MultiCell(20,8,"Jumlah",1,'C');
		$this->SetXY(250,$y+7);
		$this->MultiCell(20,8,"Satuan",1,'C');
		...
		$this->SetXY(270,$y);
		$this->MultiCell(115,7,"Daftar Barang Yang Dapat Dioptimalisasi",1,'C');
		$this->SetXY(270,$y+7);
		$this->MultiCell(30,8,"Kode Barang",1,'C');
		$this->SetXY(300,$y+7);
		$this->MultiCell(45,8,"Nama Barang",1,'C');
		...
		$this->SetXY(385,$y);
		$this->MultiCell(40,7,"Kebutuhan Rill BMD",1,'C');
		$this->SetXY(385,$y+7);
		$this->MultiCell(20,8,"Jumlah",1,'C');
		$this->SetXY(405,$y+7);
		$this->MultiCell(20,8,"Satuan",1,'C');
