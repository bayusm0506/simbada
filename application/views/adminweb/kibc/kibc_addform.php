...
<!-- Validation -->
          ...
          <tr>
          	<td>Tgl Pembelian</td><td> : <input type=text name='Tgl_Perolehan' size=10  id='datepicker' readonly='readonly' class="required input-small"></td>
          </tr>

           <tr>
           		<td>Tgl Pembukuan</td><td> : <input type=text name='Tgl_Pembukuan' size=10 id='datepicker2' value="<?php 
