...
class PDF_MC_Table_telaah_rkpbmd extends FPDF
{
...
function Rowheader()
{
		...
		$h=0;
        $this->Rect($x,$y,$w,$h);
        $this->MultiCell(15,22,"No.",1,'C');



		$this->SetXY(25,$y);
		$this->MultiCell(285,7,"Barang Yang Dipelihara",1,'C');

        $this->SetXY(25,$y+7);
        $this->MultiCell(85,15,"Program/Kegiatan/Output",1,'C');
		$this->SetXY(110,$y+7);
		$this->MultiCell(30,15,"Kode Barang",1,'C');
		$this->SetXY(140,$y+7);
		$this->MultiCell(45,15,"Nama Barang",1,'C');
		$this->SetXY(185,$y+7);
		$this->MultiCell(20,15,"Jumlah",1,'C');
		$this->SetXY(205,$y+7);
		$this->MultiCell(20,15,"Satuan",1,'C');
		$this->SetXY(225,$y+7);
		$this->MultiCell(25,15,"",1,'C');
		$this->SetXY(225,$y+10);
		$this->MultiCell(25,5,"Status Barang",0,'C');


		$this->SetXY(250,$y+7);
		$this->MultiCell(60,7,"Kondisi Barang",1,'C');
		$this->SetXY(250,$y+14);
		$this->MultiCell(20,8,"B",1,'C');
		$this->SetXY(270,$y+14);
		$this->MultiCell(20,8,"KB",1,'C');
		$this->SetXY(290,$y+14);
		$this->MultiCell(20,8,"RB",1,'C');

		$this->SetXY(310,$y);
		$this->MultiCell(90,7,"Usulan Kebutuhan Dipelihara",1,'C');
		$this->SetXY(310,$y+7);
		$this->MultiCell(50,15,"Nama Pemeliharaan",1,'C');
		$this->SetXY(360,$y+7);
		$this->MultiCell(20,15,"Jumlah",1,'C');
		$this->SetXY(380,$y+7);
		$this->MultiCell(20,15,"Satuan",1,'C');
		...
		$this->SetXY(400,$y);
		$this->MultiCell(40,5,"Rencana Kebutuhan Pemeliharaan BMD yang Disetujui",0,'C');
		$this->SetXY(400,$y+15);
		$this->MultiCell(20,7,"Jumlah",1,'C');
		$this->SetXY(420,$y+15);
		$this->MultiCell(20,7,"Satuan",1,'C');

		$this->SetXY(440,$y);
		$this->MultiCell(10,22,"Ket.",1,'C');
