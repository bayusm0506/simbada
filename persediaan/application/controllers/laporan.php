...
class Laporan extends CI_Controller {
	...
	function cetakkir()
	{
		...
		$this->load->view('adminweb/laporan/laporankir',$data);
	}
	...
	/* cetak laporan ekstrakomtabel */
	function ekstrakomtabel()
	{
		$data['title'] 		= $this->title;
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		...
		$data['jumlah_ekstrakomptabel_kiba'] 	= $this->Kiba_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['ekstrakomptabel_kiba'] 			= $this->Kiba_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_ekstrakomptabel_kiba']		= $this->Kiba_model->total_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		
		$data['jumlah_ekstrakomptabel_kibb'] 	= $this->Kibb_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['ekstrakomptabel_kibb'] 			= $this->Kibb_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_ekstrakomptabel_kibb']		= $this->Kibb_model->total_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->row();

		$data['jumlah_ekstrakomptabel_kibc'] 	= $this->Kibc_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['ekstrakomptabel_kibc'] 			= $this->Kibc_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_ekstrakomptabel_kibc']		= $this->Kibc_model->total_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);

		$data['jumlah_ekstrakomptabel_kibd'] 	= $this->Kibd_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['ekstrakomptabel_kibd'] 			= $this->Kibd_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_ekstrakomptabel_kibd']		= $this->Kibd_model->total_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);

		$data['jumlah_ekstrakomptabel_kibe'] 	= $this->Kibe_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['ekstrakomptabel_kibe'] 			= $this->Kibe_model->laporan_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_ekstrakomptabel_kibe']		= $this->Kibe_model->total_ekstrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		
		$data['total']	= $data['total_ekstrakomptabel_kiba']+ $data['total_ekstrakomptabel_kibb']->Harga + $data['total_ekstrakomptabel_kibc']+ $data['total_ekstrakomptabel_kibd']+ $data['total_ekstrakomptabel_kibe'] ;
		
		$this->load->view('adminweb/laporan/ekstrakomptabel',$data);
	}
	
	/* cetak laporan ekstrakomtabel SKPD */
	function ekstrakomtabel_skpd()
	{
		$data['title']    = $this->title;
		$kd_bidang        =  $this->input->post('kd_bidang');
		$kd_unit          =  $this->input->post('kd_unit');
		...
		$data['jumlah_ekstrakomtabel_kiba'] 	= $this->Kiba_model->laporan_ekstrakomptabel_skpd($like)->num_rows(); 
		$data['ekstrakomtabel_kiba'] 			= $this->Kiba_model->laporan_ekstrakomptabel_skpd($like); 
		$data['total_ekstrakomtabel_kiba']		= $this->Kiba_model->total_ekstrakomptabel_skpd($like);
		
		$data['jumlah_ekstrakomtabel_kibb'] 	= $this->Kibb_model->laporan_ekstrakomptabel_skpd($like)->num_rows(); 
		$data['ekstrakomtabel_kibb'] 			= $this->Kibb_model->laporan_ekstrakomptabel_skpd($like); 
		$data['total_ekstrakomtabel_kibb']		= $this->Kibb_model->total_ekstrakomptabel_skpd($like);

		$data['jumlah_ekstrakomtabel_kibc'] 	= $this->Kibc_model->laporan_ekstrakomptabel_skpd($like)->num_rows(); 
		$data['ekstrakomtabel_kibc'] 			= $this->Kibc_model->laporan_ekstrakomptabel_skpd($like); 
		$data['total_ekstrakomtabel_kibc']		= $this->Kibc_model->total_ekstrakomptabel_skpd($like);

		$data['jumlah_ekstrakomtabel_kibd'] 	= $this->Kibd_model->laporan_ekstrakomptabel_skpd($like)->num_rows(); 
		$data['ekstrakomtabel_kibd'] 			= $this->Kibd_model->laporan_ekstrakomptabel_skpd($like); 
		$data['total_ekstrakomtabel_kibd']		= $this->Kibd_model->total_ekstrakomptabel_skpd($like);

		$data['jumlah_ekstrakomtabel_kibe'] 	= $this->Kibe_model->laporan_ekstrakomptabel_skpd($like)->num_rows(); 
		$data['ekstrakomtabel_kibe'] 			= $this->Kibe_model->laporan_ekstrakomptabel_skpd($like); 
		$data['total_ekstrakomtabel_kibe']		= $this->Kibe_model->total_ekstrakomptabel_skpd($like);
		
		$data['total']	= $data['total_ekstrakomtabel_kiba'] + $data['total_ekstrakomtabel_kibb'] + $data['total_ekstrakomtabel_kibc'] + $data['total_ekstrakomtabel_kibd'] + $data['total_ekstrakomtabel_kibe'];
		$this->load->view('adminweb/laporan/gabungan_pemda/ekstrakomtabel',$data);
	}


	/* cetak laporan intrakomtabel */
	function intrakomtabel()
	{
		$data['title'] 		= $this->title;
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		...
		$data['jumlah_intrakomptabel_kiba'] 	= $this->Kiba_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['intrakomptabel_kiba'] 			= $this->Kiba_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_intrakomptabel_kiba']		= $this->Kiba_model->total_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		
		$data['jumlah_intrakomptabel_kibb'] 	= $this->Kibb_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['intrakomptabel_kibb'] 			= $this->Kibb_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_intrakomptabel_kibb']		= $this->Kibb_model->total_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);

		$data['jumlah_intrakomptabel_kibc'] 	= $this->Kibc_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['intrakomptabel_kibc'] 			= $this->Kibc_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_intrakomptabel_kibc']		= $this->Kibc_model->total_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);

		$data['jumlah_intrakomptabel_kibd'] 	= $this->Kibd_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['intrakomptabel_kibd'] 			= $this->Kibd_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_intrakomptabel_kibd']		= $this->Kibd_model->total_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);

		$data['jumlah_intrakomptabel_kibe'] 	= $this->Kibe_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like)->num_rows();
		$data['intrakomptabel_kibe'] 			= $this->Kibe_model->laporan_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		$data['total_intrakomptabel_kibe']		= $this->Kibe_model->total_intrakomptabel($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$like);
		
		$data['total']			= $data['total_intrakomptabel_kiba']+ $data['total_intrakomptabel_kibb']+ $data['total_intrakomptabel_kibc']+ $data['total_intrakomptabel_kibd']+ $data['total_intrakomptabel_kibe'] ;
		
		$this->load->view('adminweb/laporan/intrakomptabel',$data);
	}
	...
	function rekap_skpd()
	{
		...
		/* start */
		$skpd 							= $this->Sub_unit_model->get_sub_unit($kd_bidang,$kd_unit,$kd_sub,'');
		$data['jumlah'] 				= $this->Sub_unit_model->get_sub_unit($kd_bidang,$kd_unit,$kd_sub,'')->num_rows();
		$i=0;
		$nomor=1;
		foreach ($skpd->result() as $line){
			...
			$responce[$i]['cell'] 	= array($nomor,$line->Kd_Bidang,$line->Kd_Unit,$line->Kd_Sub,$line->Nm_Sub_Unit,$jumlah_a['Harga'],$jumlah_b['Harga'],$jumlah_c['Harga'],$jumlah_d['Harga'],$jumlah_e['Harga'],$jumlah_f['Harga'],$jumlah_l['Harga']);
			$i++;
			$nomor++;
...
/* cetak laporan buku induk Kib B induk */
 function kibbinduk(){
	...
	function intrakomtabel_skpd(){
		...
		$data['jumlah_intrakomptabel_kiba'] 	= $this->Kiba_model->laporan_intrakomptabel_induk($like)->num_rows();
		$data['intrakomptabel_kiba'] 			= $this->Kiba_model->laporan_intrakomptabel_induk($like);
		$data['total_intrakomptabel_kiba']		= $this->Kiba_model->total_intrakomptabel_induk($like);
		
		$data['jumlah_intrakomptabel_kibb'] 	= $this->Kibb_model->laporan_intrakomptabel_induk($like)->num_rows();
		$data['intrakomptabel_kibb'] 			= $this->Kibb_model->laporan_intrakomptabel_induk($like);
		$data['total_intrakomptabel_kibb']		= $this->Kibb_model->total_intrakomptabel_induk($like);

		$data['jumlah_intrakomptabel_kibc'] 	= $this->Kibc_model->laporan_intrakomptabel_induk($like)->num_rows();
		$data['intrakomptabel_kibc'] 			= $this->Kibc_model->laporan_intrakomptabel_induk($like);
		$data['total_intrakomptabel_kibc']		= $this->Kibc_model->total_intrakomptabel_induk($like);

		$data['jumlah_intrakomptabel_kibd'] 	= $this->Kibd_model->laporan_intrakomptabel_induk($like)->num_rows();
		$data['intrakomptabel_kibd'] 			= $this->Kibd_model->laporan_intrakomptabel_induk($like);
		$data['total_intrakomptabel_kibd']		= $this->Kibd_model->total_intrakomptabel_induk($like);

		$data['jumlah_intrakomptabel_kibe'] 	= $this->Kibe_model->laporan_intrakomptabel_induk($like)->num_rows();
		$data['intrakomptabel_kibe'] 			= $this->Kibe_model->laporan_intrakomptabel_induk($like);
		$data['total_intrakomptabel_kibe']		= $this->Kibe_model->total_intrakomptabel_induk($like);
		
		$data['total']			= $data['total_intrakomptabel_kiba']+ $data['total_intrakomptabel_kibb']+ $data['total_intrakomptabel_kibc']+ $data['total_intrakomptabel_kibd']+ $data['total_intrakomptabel_kibe'] ;
		
		$this->load->view('adminweb/laporan/gabungan_pemda/intrakomptabel',$data);
	}
	...
	function pengadaan()
	{
		...
		$this->load->view('adminweb/laporan/inventaris/pengadaan',array_merge($data,$get_ttd));
	}
	...
	function persediaan()
	{
		// if(!$this->general->privilege_check('LAPORAN_PERSEDIAAN',VIEW))
		//     $this->general->no_access();
		
		$data['header']        = "CETAK LAPORAN PERSEDIAAN";
		$data['title']         = $this->title;
		$data['option_bidang'] = $this->Model_chain->getBidangList();
		$this->template->load('template','adminweb/laporan/persediaan/data',$data);
	}

	function buku_persediaan()
	{
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		$kd_sub		=  $this->input->post('kd_sub_unit');
		...
		$data['title'] 		= "BUKU BARANG HABIS PAKAI";
		...
		$like  = "AND Tgl_Diterima BETWEEN '$tahunawal' AND '$tahunakhir'";
		$like2 = "AND Tgl_Pengeluaran BETWEEN '$tahunawal' AND '$tahunakhir'";
		...
		// $data['jumlah'] = $this->Penerimaan_model->buku_persediaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like)->num_rows();
		// $data['data']   = $this->Penerimaan_model->buku_persediaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like);
		
		$masuk 		= $this->Penerimaan_model->get_penerimaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like); $i=0; $nomor=1; $jumlah_akhir = 0; $nilai_akhir  = 0; $responce = array(); foreach ($masuk->result() as $line){$keluar 			  = $this->Pengeluaran_model->get_pengeluaran($line->Kd_Prov,$line->Kd_Kab_Kota,$line->Kd_Bidang,$line->Kd_Unit,$line->Kd_Sub,$line->Kd_UPB,$line->No_ID,$line->Kd_Aset1,$line->Kd_Aset2,$line->Kd_Aset3,$line->Kd_Aset4,$line->Kd_Aset5,$line->Kd_Aset6,$line->No_Register,$like2); $spek = $line->Merk." / ".$line->Ukuran; $kontrak = tgl_dmy($line->Tgl_Kontrak)."/".$line->No_Kontrak."/ Rp. ".rp($line->Harga); $responce[$i]['cell'] = array($nomor,tgl_dmy($line->Tgl_Diterima),$line->Nm_Aset6." ".$line->Spesifikasi,$spek,$line->Tahun_Pembuatan,$line->Jumlah." ".$line->Nm_Satuan,$kontrak,tgl_dmy($line->Tgl_BA_Pemeriksaan),$line->No_BA_Pemeriksaan,'','','','',$line->Keterangan); $jumlah_keluar = 0; $nilai_keluar  = 0; if($keluar->num_rows() > 0 ){foreach ($keluar->result() as $row){$bast = tgl_dmy($row->Tgl_BAST)."/".$row->No_BAST; $responce[++$i]['cell'] = array('','','','','','','','','',tgl_dmy($row->Tgl_Pengeluaran),$row->Kepada,rp($row->Jumlah)." ".$line->Nm_Satuan,$bast,$row->Keterangan); $jumlah_keluar += $row->Jumlah; $nilai_keluar  += $row->Jumlah * $line->Harga; } } $nilai_awal   = $line->Jumlah * $line->Harga; $jumlah_akhir = $line->Jumlah - $jumlah_keluar; $nilai_akhir   = $nilai_awal - $nilai_keluar; $responce[++$i]['cell'] = array('x',$line->Jumlah." ".$line->Nm_Satuan,"Rp. ".rp($nilai_awal), $jumlah_keluar." ".$line->Nm_Satuan, "Rp. ".rp($nilai_keluar),$jumlah_akhir." ".$line->Nm_Satuan, "Rp. ".rp($nilai_akhir),'','','','','','',''); $i++; $nomor++; }
		// print_r($responce); exit();
		$data['jumlah'] = $i;
		$data['response'] = $responce;

		$this->load->view('adminweb/laporan/persediaan/buku_persediaan',array_merge($data,$get_ttd));
	}

	function buku_penerimaan()
	{
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		$kd_sub		=  $this->input->post('kd_sub_unit');
		...
		$data['title'] 		= "BUKU PENERIMAAN BARANG HABIS PAKAI";
		...
		$data['jumlah'] = $this->Penerimaan_model->buku_penerimaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like)->num_rows();
		$data['data']   = $this->Penerimaan_model->buku_penerimaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like);

		$this->load->view('adminweb/laporan/persediaan/buku_penerimaan',array_merge($data,$get_ttd));
	}

	function buku_pengeluaran()
	{
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		$kd_sub		=  $this->input->post('kd_sub_unit');
		...
		$data['title'] 		= "BUKU PENGELUARAN BARANG HABIS PAKAI";
		...
		$data['jumlah'] = $this->Pengeluaran_model->buku_pengeluaran($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like)->num_rows();
		$data['data']   = $this->Pengeluaran_model->buku_pengeluaran($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like);

		$this->load->view('adminweb/laporan/persediaan/buku_pengeluaran',array_merge($data,$get_ttd));
	}

	/* cetak laporan rekap persediaan */
	function rekap_persediaan()
	{
		$kd_bidang	=  $this->input->post('kd_bidang');
		$kd_unit	=  $this->input->post('kd_unit');
		$kd_sub		=  $this->input->post('kd_sub_unit');
		...
		$data['title'] 		= "REKAP BARANG PERSEDIAAN";
		...
		/* Persediaan */
		$data['jumlah'] = $this->Penerimaan_model->rekap_persediaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like)->num_rows();
		$data['data']   = $this->Penerimaan_model->rekap_persediaan($kd_bidang,$kd_unit,$kd_sub,$kd_upb,$tahunawal,$tahunakhir,$like);
		
		$this->load->view('adminweb/laporan/persediaan/rekap_persediaan',array_merge($data,$get_ttd));
	}
