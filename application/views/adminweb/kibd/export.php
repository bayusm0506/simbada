<?php
error_reporting(0);
$nama_file = date('Y-m-d')."_KIB_D_".str_replace(' ', '_', $nama_upb->Nm_UPB).".xls";    
...
<tr>
<td></td>
<td height="40" align="center" class="title">KIB D. JALAN, IRIGASI & JARINGAN</td>
</tr>
<tr>
  <td></td>
  <td>
  <p align="center"><strong>KARTU INVENTARIS BARANG (KIB) D. JALAN, IRIGASI & JARINGAN</strong></p>
