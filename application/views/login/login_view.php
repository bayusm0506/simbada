...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>LOGIN SIMBADA ONLINE 00</title>
                                    ...
                                    <strong>Error!</strong> ' . $message . '</div>';
                                     ...
                                     <div class="control-group">
                                                    ...
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <div class="input-prepend">
                                                                ...
                                                                <select name="tahun" style="height: 40px; width: 265px;">
															      <?php
																    for ($i=2016;$i<=2018;$i++)
																    {
																    	$tahun=$i;
                                                    ...
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <?php echo $img; ?>
                                                            <input type="text" name="kode_aman" placeholder="  Ketik kode keamanan" required="required" style="width: 150px; height: 36px; padding: 0; margin-top: 10px; box-shadow: 0;border-radius: 0px; ">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <span class="text-small">Belum punya akun?</span><br><a href="#">silahkan daftarkan di bagian Aset BPKAD</a>
                                                        </div>
                                                    </div>
                                    </form>
