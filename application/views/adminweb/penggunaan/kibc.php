...
<script>
	...
	if(confirm("Yakin data ini akan dihapus dalam usulan penggunaan ??"))
	{
		$( "#loading" ).empty().append("<img src='<?php echo base_url();?>media/images/ui-anim_basic_16x16.gif' /> tunggu sebentar...");
		$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>penggunaan/hapus_usul",
				data:kode,
			 	cache: false,
...
<!-- end hapus data ->
	...
	if(confirm("Yakin data yang dipilih akan dihapus dalam usulan pengunaan ??")){	
		i=0;
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($kibc) ?  $kibc: '#'; ?>" class="tab-page" data-toggle="tab">KIB C
