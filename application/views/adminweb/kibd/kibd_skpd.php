...
<script>
	$(function() {
		...
		kd_upb: $("#kd_upb").val(),
				  ...
				  $.ajax({
					url : "<?php echo site_url('kibd/pindahskpd')?>",
					type : 'POST',
					data : kode,
					success: function(msg){
...
<div class="row">
            <div class="span12">
                ...
                <div class="panel">
                    <div class="panel-header"><i class="icon-group"></i><?php echo ! empty($header) ?  $header: 'KIB D. JALAN,IRIGASI & JARINGAN'; ?>
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($tab1) ?  $tab1: '#'; ?>" class="tab-page" data-toggle="tab">DATA KIB D. JALAN,IRIGASI & JARINGAN</a></li>
