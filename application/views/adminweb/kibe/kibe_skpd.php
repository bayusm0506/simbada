...
<div class="row">
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($tab1) ?  $tab1: '#'; ?>" class="tab-page" data-toggle="tab">DATA KIB E. ASET TETAP LAINYA</a></li>
                            ...
                            <?php if ($this->session->userdata('lvl') != '03' ){ ?>
                                ...
                                <a href="<?php echo ! empty($tab3) ?  $tab3: '#'; ?>" class="tab-page"  data-toggle="tab">DATA PER SKPD
                                <span class="badge"><?php echo !empty($jml_skpd) ? $jml_skpd : '0';?></span></a></li>
							<?php } ?>                                
                        </ul>
		...
		echo '</li><li>'
			.anchor(current_url().'#',"<i class='icon-random'></i>Kapitalisasi",array('class'=> 'pindah','Kd_Prov' => $row->Kd_Prov,'Kd_Kab_Kota' => $row->Kd_Kab_Kota,'Kd_Bidang' => $row->Kd_Bidang,'Kd_Unit' => $row->Kd_Unit,'Kd_Sub' => $row->Kd_Sub,'Kd_UPB' => $row->Kd_UPB,'Kd_Aset1' => $row->Kd_Aset1,'Kd_Aset2' => $row->Kd_Aset2,'Kd_Aset3' => $row->Kd_Aset3,'Kd_Aset4' => $row->Kd_Aset4,'Kd_Aset5' => $row->Kd_Aset5,'No_Register' => $row->No_Register,'no'=>$i));
		echo "</li>
                                                </ul>
                                            </div>
                                        </td>
