...
<!-- Validation -->
           <form method=POST action="<?php echo site_url('pengadaan/kibd_process'); ?>" name='fadd' id='formku'>
          <table  width='100%'>
          ...
          <input type=text name='Nm_Aset5' size=150 id='Nm_Aset5' readonly='readonly' value="<?php echo Nama_Aset($Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5); ?>" placeholder="ketik nama barang disini !" class="input-large">
           ...
           <span id='register'>
		       <input type=text name='No_Register' value="<?php echo KIBD_lastRegister($Kd_Prov,$Kd_Kab_Kota,$Kd_Bidang,$Kd_Unit,$Kd_Sub,$Kd_UPB,$Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5); ?>" size=5 id="No_Register" class="required input-mini" readonly='readonly'>
		   </span>
              <span id="msg"></span>     
           </td>
           </tr>
          ...
          <tr>
            <td>Konstruksi</td>    <td> : <input type=text name='Konstruksi' maxlength="20" size=15 class="input-small"> Panjang : <input type=text name='Panjang' size=15 class="input-small" onkeyup="numericFilter(this);" onblur="if (this.value == '') {this.value = '0';}" onfocus="if (this.value == '0') {this.value = '';}" ></td>
            </tr>
            
            <tr>
            <td>Lebar (M)</td>    <td> : <input type=text name='Lebar' size=15 class="input-small" onkeyup="numericFilter(this);" onblur="if (this.value == '') {this.value = '0';}" onfocus="if (this.value == '0') {this.value = '';}"> Luas (M2) : <input type=text name='Luas' size=15 class="input-small" onkeyup="numericFilter(this);" onblur="if (this.value == '') {this.value = '0';}" onfocus="if (this.value == '0') {this.value = '';}"></td>
            </tr>
      ...
      <tr>
        <td>Tgl Dokumen</td>    <td> : <input type=text name='Dokumen_Tanggal' size=10 id='datepicker3' readonly='readonly' class="input-medium"> 
          Nomor Dokumen : 
