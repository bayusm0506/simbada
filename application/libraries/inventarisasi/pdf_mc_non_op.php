...
class PDF_MC_Non_Op extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(135,$y2+3);
		$this->MultiCell(30,15,"Judul",1,'C');
		
		$this->SetXY(165,$y2+3);
		$this->MultiCell(30,15,"",1,'C');
		$this->SetXY(165,$y2+8);
		$this->MultiCell(30,5,"Pencipta",0,'C');
		...
		$this->MultiCell(25,20,"",1,'C');
		$this->SetXY(265,$y+5);
		$this->MultiCell(25,4,"Ukuran Barang",0,'C');
...
function Header()
{
    ...
    $this->Cell(0,9,'DAFTAR ASET NON OPERASIONAL',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
