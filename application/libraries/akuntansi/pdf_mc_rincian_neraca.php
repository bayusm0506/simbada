...
class PDF_MC_rincian_neraca extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(60,$y);
		$this->MultiCell(175,15,"",1,'C');
		$this->SetXY(60,$y2+3);
		$this->MultiCell(175,5,"Nama Barang",0,'C');
		
		$this->SetXY(235,$y);
		$this->MultiCell(58,15,"",1,'C');
		$this->SetXY(235,$y2);
		$this->MultiCell(58,5,"Total\n(Rupiah)",0,'C');
}
...
function Header()
{
    ...
    $this->Cell(0,9,'RINCIAN BARANG KE NERACA',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(50,175,58));

	$this->SetAligns(array('C','C','C'));
	$this->RowJudul(array("1", "2", "3"));
