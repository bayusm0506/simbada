 ...
 * Contoh_model Class
 */
class Rkpbu_model extends CI_Model {
	/**
	 * Constructor
	 */
	...
	function get_page($limit, $offset, $where='', $like){
       ...
       $sql ="SELECT * FROM ( 
				SELECT b.Nm_Aset5,a.*,c.Nm_Rek_5,ROW_NUMBER() OVER (ORDER BY a.Log_entry DESC) AS urutan FROM Ta_RKPBU a
 	...
 	function get_rkpbu_by_id($kd_prov,$kd_kab,$bidang,$unit,$sub,$upb,$kd_aset1,$kd_aset2,$kd_aset3,$kd_aset4,$kd_aset5,$kd_aset6,$no_id)
	{
		...
		if ($this->session->userdata('lvl') == 01){
			...
			$query = "SELECT b.Nm_Aset6,b.Spesifikasi,a.*,c.Nm_Rek_5 FROM Ta_RKPBU a
	...
	{	
		...
		$query   = "SELECT MAX(No_ID) as No_ID FROM Ta_RKPBU WHERE 1=1 $where";
	...
	function save($data){
        ...
        $arr = array(
			...
			'Uraian'      => isset($data['Uraian']) ? $data['Uraian']: '',
        ...
        // print_r($arr); exit();
        return $this->db->insert('Ta_RKPBU',$arr);
	...
	{
		$this->db->delete("Ta_RKPBU", array('Tahun' => $tahun,'Kd_Prov' => $kd_prov,'Kd_Kab_Kota' => $kd_kab,'Kd_Bidang' => $kd_bidang,'Kd_Unit' => $kd_unit,
	...
	function update($data){
        ...
        $this->db->update('Ta_RKPBU',$arr);
        // echo $this->db->last_query(); die;
        return true;
    }

    function laporan_usul_rkpbu($bidang='',$unit='',$sub='',$upb='',$tahunawal,$tahunakhir,$like)
	{			
		...
		$query = "SELECT d.Ket_Kegiatan,b.Nm_Aset5,a.*,c.Nm_Rek_5 FROM Ta_RKPBU a
				LEFT JOIN Ref_Rek_Aset5 b ON a.Kd_Aset1=b.Kd_Aset1 AND a.Kd_Aset2=b.Kd_Aset2 AND a.Kd_Aset3=b.Kd_Aset3 AND 
				a.Kd_Aset4=b.Kd_Aset4 AND a.Kd_Aset5=b.Kd_Aset5
				LEFT JOIN Ref_Rek_5 c ON a.Kd_Rek_1=c.Kd_Rek_1 AND a.Kd_Rek_2=c.Kd_Rek_2 AND a.Kd_Rek_3=c.Kd_Rek_3 AND a.Kd_Rek_4=c.Kd_Rek_4 AND a.Kd_Rek_5=c.Kd_Rek_5
	 ...
	 function laporan_rkpbu($bidang='',$unit='',$sub='',$upb='',$tahunawal,$tahunakhir,$like)
	{			
