...
<!-- Validation -->
		 ...
		 <tr><td>Kode Aset</td>    <td>  
          ...
          <tr>
            <td>Konstruksi</td>    <td> : <input type=text name='Konstruksi' size=15 class="input-small"> Panjang : <input type=text name='Panjang' size=15 class="input-small"></td>
            </tr>
            
            <tr>
            <td>Lebar (M)</td>    <td> : <input type=text name='Lebar' size=15 class="input-small"> Luas (M2) : <input type=text name='Luas' size=15 class="input-small"></td>
            </tr>
		  ...
		  <tr><td colspan='3'><textarea name='Keterangan' style='width: 600px; height: 80px;'></textarea></td>  </tr>
