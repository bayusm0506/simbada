                ...
                <!-- Validation -->
                          <form method=POST action="<?php echo $form_action; ?>" name='fadd' id='formku'>
                              ...
                              <table  width='100%'>
                                ...
                                <tr>
                                  <td>No Dokumen</td>
                                  <td> : <input type=text name='No_Dokumen' maxlength="50" size=15 required ></td>          
                                </tr>
                                ...
                                <tr>
                                  <td colspan='3'><textarea name='Keterangan' maxlength="250" style='width: 600px; height: 80px;'></textarea></td>
                                </tr>
