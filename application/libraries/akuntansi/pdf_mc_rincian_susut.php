...
class PDF_MC_rincian_susut extends FPDF
{
...
function UPBTitle2($kode_lokasi)
{
        ...
        $this->Ln();
        $this->Cell(19,5,'KABUPATEN/KOTA',0,0,'L');
...
function Rowheader()
{
		...
		$this->SetXY(10,$y);
		$this->MultiCell(35,15,"",1,'C');
		$this->SetXY(10,$y2+3);
		$this->MultiCell(35,5,"Kode Barang",0,'C');

		$this->SetXY(45,$y);
		$this->MultiCell(90,15,"",1,'C');
		$this->SetXY(45,$y2+3);
		$this->MultiCell(90,5,"Nama Barang",0,'C');
		
		$this->SetXY(135,$y);
		$this->MultiCell(40,15,"",1,'C');
		$this->SetXY(135,$y2);
		$this->MultiCell(40,5,"Nilai Buku Awal\n(Rupiah)",0,'C');
        ...
        $this->MultiCell(40,15,"",1,'C');
        $this->SetXY(215,$y);
        $this->MultiCell(40,5,"Akumulasi Penyusutan\n(Rupiah)",0,'C');

        $this->SetXY(255,$y);
        $this->MultiCell(40,15,"",1,'C');
        $this->SetXY(255,$y2);
        $this->MultiCell(40,5,"Nilai Buku Akhir\n(Rupiah)",0,'C');
        $this->Ln(3.2);
}
...
function Header()
{
    ...
    $this->Cell(0,9,'RINCIAN BARANG PENYUSUTAN',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(35,90,40,40,40,40));
