...
<tr>
<td></td>
<td height="40" align="center" class="title">PENETAPAN STATUS PENGGUNAAN BARANG MILIK DAERAH</td>
</tr>
<tr>
  <td></td>
  <td>
...
<td>
  <table width="100%" border="1" cellpadding="8" style="border-collapse:collapse;">      
      <tr height="40" style="background-color:#9AE456;">
        ...
        <td width="249" rowspan="2" style="text-align: center; font-weight: bold;">No. Register</td>
      ...
      <tr>
        ...
        <td colspan="5" valign="top" bgcolor="#FDF8F4" style="text-align: center">8</td>
	...
	?>
      <tr>
        ...
        <td width="17" valign="top"><?php echo $dp->Kd_Aset1; ?></td>
        <td valign="top" align="center"><?php if($dp->jumlah_register > 1){ 
		echo $dp->min_register.' s/d '.$dp->max_register; }else{ echo $dp->min_register;}  ?></td>
