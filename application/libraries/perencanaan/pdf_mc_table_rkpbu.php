...
class PDF_MC_Table_rkpbu extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(110,$y2);
		$this->MultiCell(50,5,"Uraian Pemeliharaan",0,'C');

		$this->SetXY(160,$y);
		$this->MultiCell(40,15,"Lokasi",1,'C');
		...
		$this->SetXY(230,$y2-2);
		$this->MultiCell(20,5,"Jumlah Barang",0,'C');

		$this->SetXY(250,$y);
		$this->MultiCell(45,15,"Harga Satuan",1,'C');

		$this->SetXY(295,$y);
		$this->MultiCell(45,15,"Jumlah Biaya",1,'C');
		
		$this->SetXY(340,$y);
		$this->MultiCell(70,15,"Kode Rekening",1,'C');
...
function Header()
{
    ...
    $this->Cell(0,9,'DAFTAR RENCANA KEBUTUHAN PEMELIHARAAN BARANG',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(15,85,50,40,30,20,45,45,70,40));
