...
<!-- Validation -->
       <form method=POST action="<?php echo $form_action; ?>" name='fadd' id='formku'>
	           <table width='100%'>
                  <tr>
                    <td>Tahun</td>
                          <td>: <input type=text name='Tahun' class='input-small required' value="<?php echo $Tahun; ?>" /></td>
                  </tr>
                      <tr>
                    <td>Pilih KIB</td>
                          <td>: <?php
                        ...
                        echo form_dropdown('Kd_Aset1', $data, $Kd_Aset1);
                        ?></td>
                  </tr>
                      <tr>
                    <td>Minimal Satuan</td>
                          <td>: <input type=text name='Harga' size=15 id='harga' value="<?php echo nilai($Harga); ?>"><span id='pesan2'></span></td>
                  </tr>
