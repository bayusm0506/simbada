...
<!-- Validation -->
           <form method=POST action="<?php echo base_url().'pengadaan/kibe_process'; ?>" name='fadd' id='formku'>
          <table  width='100%'>
          ...
          <input type=text name='Nm_Aset5' size=150 id='Nm_Aset5' readonly='readonly' value="<?php echo Nama_Aset($Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5); ?>" placeholder="ketik nama barang disini !" class="input-large">
           ...
           <span id='register'>
		       <input type=text name='No_Register' value="<?php echo KIBE_lastRegister($Kd_Prov,$Kd_Kab_Kota,$Kd_Bidang,$Kd_Unit,$Kd_Sub,$Kd_UPB,$Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5); ?>" size=5 id="No_Register" class="required input-mini" readonly='readonly'>
		   </span>
              <span id="msg"></span>     
           </td>
           </tr>
          ...
          <tr>
            <td>Judul</td>    <td> : <input type=text name='Judul' size=50 id="Judul" class="input-xlarge" ></td>
            </tr>
          <tr>
