...
EOD;
	...
	$sql = "insert into chat (chat.from,chat.to,message,sent,chat.ip_address) values
	('".mysql_real_escape_string($from)."', 
	'".mysql_real_escape_string($to)."','".mysql_real_escape_string($message)."',NOW(),'".mysql_real_escape_string($ip)."')";
	$query = mysql_query($sql);
	echo "1";
	exit(0);
}
