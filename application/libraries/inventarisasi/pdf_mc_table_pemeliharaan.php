...
class PDF_MC_Table_pemeliharaan extends FPDF
{
...
function Rowheader()
{
		...
		$this->SetXY(75,$y);
		$this->MultiCell(190,5,"SPESIFIKASI BARANG",1,'C');
		$this->SetXY(75,$y2+3);
		...
		$this->SetXY(215,$y2+7);
		$this->MultiCell(25,3,"Asal/Cara\n Perolehan",0,'C');
		
		$this->SetXY(240,$y2+3);
		$this->MultiCell(25,20,"",1,'C');
		$this->SetXY(240,$y2+7);
		$this->MultiCell(25,3,"Tahun\nPerolehan",0,'C');
		
		$this->SetXY(265,$y);
		$this->MultiCell(30,20,"",1,'C');
		$this->SetXY(265,$y+5);
		$this->MultiCell(30,4,"Tanggal Pemeliharaan",0,'C');
		
		
		$this->SetXY(295,$y);
		$this->MultiCell(40,20,"",1,'C');
		$this->SetXY(295,$y+7);
		$this->MultiCell(40,5,"No Dokumen",0,'C');
...
function Header()
{
    ...
    $this->Cell(0,9,'BUKU PEMELIHARAAN',0,0,'C');
	$this->Ln();
	$this->SetFont('Arial','B','10');
	$this->SetWidths(array(15,30,20,60,30,30,20,25,25,30,40,25,40,50));
