...
<div class="row">
            <div class="span12">
                ...
                <div class="panel">
                    <div class="panel-header"><i class="icon-sign-blank"></i><?php echo ! empty($header) ?  $header: 'Pilih data UPB'; ?></div>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example">
	...
	echo "<tr class='gradeA' onclick='test()'>
			...
			<td align='center'>".$row->Kd_UPB."</td>
			<td>".anchor($link_kib.'/'.$row->Kd_Bidang.'/'.$row->Kd_Unit.'/'.$row->Kd_Sub.'/'.$row->Kd_UPB,$row->Nm_UPB,array('class' => 'update'))."</td>
        </tr>";
	 $i++;
	}              
?>	
