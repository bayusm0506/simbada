<?php
	...
	while ($update_mf > 1) {
		...
		$k = cek_kapitalisasi_kib_b($Kd_Prov,$Kd_Kab_Kota,$Kd_Bidang,$Kd_Unit,$Kd_Sub,$Kd_UPB,$Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5,$No_Register,$curr_thn)->row();
		...
		$cek_kondisi = cek_kondisi_kib_b($Kd_Prov,$Kd_Kab_Kota,$Kd_Bidang,$Kd_Unit,$Kd_Sub,$Kd_UPB,$Kd_Aset1,$Kd_Aset2,$Kd_Aset3,$Kd_Aset4,$Kd_Aset5,$No_Register,$curr_thn);
	...
	$pdf->Output("SIMDO_KIB_B_Penyusutan.pdf","I");
?>