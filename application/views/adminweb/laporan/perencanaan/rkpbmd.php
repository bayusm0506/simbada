<?php
	...
	$this->load->library('perencanaan/PDF_MC_Table_rkpbmd');
	
	$pdf=new PDF_MC_Table_rkpbmd('L','mm','f4');
	$pdf->Open();
	$pdf->AddPage();
	$pdf->Image(base_url().'asset/img/logo.png',10,5,22,0,'PNG');
	$pdf->SetFont('Arial','B',15);
	$pdf->MultiCell(435,5,"RENCANA KEBUTUHAN BARANG MILIK DAERAH PEMELIHARAAN \n ".NM_PEMDA,0,'C');
