...
<!-- Validation -->
		  ...
		  <tr><td colspan='3'><textarea name='Dipergunakan' maxlength="250" id='loko' style='width: 600px; height: 40px;' placeholder="Ketik disini. Pisahkan dengan tanda koma (,) [max 250 karakter]"></textarea></td></tr>
