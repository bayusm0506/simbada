...
<script type="text/javascript">
	    $(this).ready( function() {
    		$("#Nm_Aset5").autocomplete({
        		...
        		function(req, add){
          			$.ajax({
		        		url: "<?php echo base_url(); ?>kibe/json",
		          		dataType: 'json',
		          		type: 'POST',
		          		data: req,
		          		success:    
         	...
         	select: 
				...
				$.ajax({
									type: "POST",
									url : "<?php echo base_url(); ?>kibe/register",
									data: kode,
		...
		<script type="text/javascript">			
			$(document).ready(function(){	
				...
				$("#kode-search").click(function(){
					...
					$("#tkodebarang").jqGrid({
					url: '<?php echo base_url(); ?>kibe/lookup',
					datatype: "json", 
					mtype: 'GET',
...
<!-- Validation -->
		  ...
		  echo $tgl; ?>" id='datepicker' readonly='readonly'  class="input-small required"></td>
            </tr>
		   ...
		   echo $tgl ?>" id='datepicker2' readonly='readonly'  class="input-small required"></td>
            </tr>
          <tr>
            <td>Judul</td>    <td> : <input type=text name='Judul' size=50 id="Judul" value="<?php echo $default['Judul']; ?>"></td>
            </tr>
          <tr>
            <td>Pencipta</td>    <td> : <input type=text name='Pencipta' size=50 id="Pencipta" value="<?php echo $default['Pencipta']; ?>"></td>
            </tr>
          <tr>
            <td>Spesifikasi</td> <td> : <input type=text name='Bahan' size=30 id="Bahan" value="<?php echo $default['Bahan']; ?>"></td>
            </tr>
		  ...
		  ?> | Masa Manfaat  <input type=text name='Masa_Manfaat' size=15 value="<?php echo $default['Masa_Manfaat']; ?>" class="input-mini"></td>
		    </tr>
		  <tr>
          <td>Harga</td>    
