...
<script>
	...
	if(confirm("Yakin data yang dipilih akan dihapus dalam usulan penghapusan ??")){	
		...
		$("input.checkbox1:checked").each(function(){
			...
			$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>penghapusan/ajax_hapus_b",
					data:kode,
					cache: false,
...
$(".batal_usulan").click(function(event) {
	...
	if(confirm("Yakin data ini akan dihapus dalam usulan penghapusan ??"))
	{
		...
		$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>penghapusan/hapus_usul_b",
				data:kode,
			 	cache: false,
			 	success: function(html){
			 		$("#listhapus_"+no).fadeTo(300,0, function() {
...
<a class="a-link" href="'.site_url('penghapusan/rincian_kibb/'.encrypt_url($sk_tmp)).'"> Daftar Penghapusan </a> <span class="pull-right">SK PENGHAPUSAN : ' . strtoupper($sk_tmp) . '</span></p>': '';?>
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($kibb) ?  $kibb: '#'; ?>" class="tab-page" data-toggle="tab">KIB B
                            ...
                            <div class="tab-pane list-pane active" id="tab1">
                                ...
                                <div class="pull-right">
                                    <form class="form-inline" method="POST" id="form_view" action=<?php echo base_URL(); ?>penghapusan/set/>
                                     ...
                                     <span><strong> Tgl Usulan </strong></span>
