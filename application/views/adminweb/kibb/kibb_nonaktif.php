...
<div class="row">
                ...
                <div class="panel">
             	...
             	<div class="panel-content list-content">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo ! empty($tab1) ?  $tab1: '#'; ?>" class="tab-page" data-toggle="tab">DATA KIB B. PERALATAN & MESIN</a></li>
                  ...
                  <table class="table table-striped">
					...
					$thn 		= date('Y', strtotime($row->Tgl_Perolehan));
                      echo "<tr id='listhapus_$i'>
                          ...
                          <td>$i</td>
                          <td>".$status.$row->Nm_Aset5."</td>
						  <td>$row->No_Register</td>
						  <td>".tgl_indo($row->Tgl_Perolehan)."</td>
						  <td>".tgl_indo($row->Tgl_Pembukuan)."</td>
			...
			echo '<li>'.anchor(current_url().'#',"<i class='icon-refresh'></i>Pindah Ruang",array('class'=> 'pindah_ruang','Kd_Aset1' => $row->Kd_Aset1,'Kd_Aset2' => $row->Kd_Aset2,'Kd_Aset3' => $row->Kd_Aset3,'Kd_Aset4' => $row->Kd_Aset4,'Kd_Aset5' => $row->Kd_Aset5,'No_Register' => $row->No_Register,'Kd_Ruang' => $row->Kd_Ruang,'no'=>$i)).'</li>';
